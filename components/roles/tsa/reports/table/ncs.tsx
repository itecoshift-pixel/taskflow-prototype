...
export const NCSTable: React.FC<{
  referenceid: string;
  target_quota?: string;
    ...
    >
      ...
      >
        ...
        <Select value={filterClient} onValueChange={setFilterClient}>
          <SelectTrigger
            className="h-8 w-[160px] text-[10px] font-bold uppercase tracking-widest border"
            style={{
            ...
            <TableBody>
              {paginated.map((item) => (
                ...
                >
                  ...
                  <TableCell style={tdStyle} className="capitalize font-medium">{item.type_client || "—"}</TableCell>
                </TableRow>
              ))}
            </TableBody>
