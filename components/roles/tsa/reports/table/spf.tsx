...
export const SPFTable: React.FC<{
  referenceid: string;
  target_quota?: string;
    ...
    >
      ...
      >
        ...
        <div className="relative flex-1 min-w-[180px] max-w-sm">
          ...
          />
          <Input
            placeholder="Search company, SO number, remarks..."
            value={searchTerm}
            ...
            <TableBody>
              {paginated.map((item) => (
                ...
                >
                  ...
                  <TableCell style={tdStyle} className="uppercase font-bold font-mono">{item.so_number || "—"}</TableCell>
                  <TableCell style={tdStyle} className="font-bold text-right">{item.so_amount != null ? fmt(item.so_amount) : "—"}</TableCell>
                  ...
                  <TableCell style={tdStyle} className="capitalize font-medium">{item.call_type || "—"}</TableCell>
                </TableRow>
              ))}
            </TableBody>
